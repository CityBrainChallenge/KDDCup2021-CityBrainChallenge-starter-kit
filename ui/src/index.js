    ...
    if (map.isStyleLoaded()) {
      ...
      data[1].forEach(function (item, index, array) {
        if (item === 0) {
          red.push({
            'type': 'Feature',
            'geometry': { 'type': 'Point', 'coordinates': tpos[index] }
          })
        } else if (item === 1) {
          green.push({
            'type': 'Feature',
      ...
      if (map.getSource('redlight')) map.getSource('redlight').setData(pointsdata);
      pointsdata = { 'type': 'FeatureCollection', 'features': green };
      if (map.getSource('greenlight')) map.getSource('greenlight').setData(pointsdata);
      pointsdata = { 'type': 'FeatureCollection', 'features': yellow };
      if (map.getSource('yellowlight')) map.getSource('yellowlight').setData(pointsdata);
      ...
      <div>
        <div className='absolute ml12 mt12 bg-white z1'>
          <div>
            <Button type="primary">
              <div>
                <div className="ant-upload-text" onClick={this.ClickStart}>Start</div>
              </div>
            </Button>
          </div>
          <div>
            <Button type="primary">
              <div>
                <div className="ant-upload-text" onClick={this.ClickPause}>Pause</div>
              </div>
            </Button>
          </div>
          <div>
            <Button type="primary">
              <div>
                <div className="ant-upload-text" onClick={this.ClickRestart}>Restart</div>
              </div>
            </Button>
          </div>
          <div>
          ...
          <div>
            <Button type="primary">
              <div>
                <div className="ant-upload-text" onClick={this.ClickReset}>TimeSet</div>
              </div>
            </Button>
            <Input
